...
const InstructorCard = () => {
  return (
    <div className="relative flex flex-col md:flex-row w-full my-6 bg-secondary shadow-sm border border-slate-200 rounded-lg">
      ...
      <div className="p-6">
      <div className="flex items-center justify-between">  <div className="flex-col justify-start items-center">
      ...
      <ul className="list-disc pl-5 text-gray-600">
        ...
        <h6 className="text-amber-600 font-bold text-xl">Javascript Development</h6>
