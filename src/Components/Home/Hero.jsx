    ...
    return (
        ...
        >
            <SwiperSlide>
                <div className={`w-full h-full` }>
                                    ...
                                    <div className='w-[50%] h-full flex flex-col gap-5 justify-center items-start pl-24 absolute top-0 left-0'>
                                        <h1 className='text-5xl text-secondary font-bold'>2727+ Online <br /> Courses from the <br /> Best Tutors three</h1>    
            ...
            <div className='slide-manager w-[35%] h-[20%] flex items-center gap-2 absolute bottom-2 right-4 z-50'>
                <div onClick={() => handleSlideClick(0)} className={`w-full h-full ${currentSlide === 0 && 'border-5 border-secondary'}`}>
                    <img src={banner9} alt="Banner Image" className={`w-full h-full `}/>
                </div>
                <div onClick={() => handleSlideClick(1)} className={`w-full h-full ${currentSlide === 1 && 'border-5 border-secondary'}`}>
                    <img src={banner9} alt="Banner Image" className={`w-full h-full `}/>
                </div>
                <div onClick={() => handleSlideClick(2)} className={`w-full h-full ${currentSlide === 2 && 'border-5 border-secondary'}`}>
                    <img src={banner9} alt="Banner Image" className={`w-full h-full `}/>
                </div>
            </div>
        </div>
