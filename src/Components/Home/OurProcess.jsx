    ...
    return (
        <div className="w-full p-4 bg-white shadow-lg rounded-md">
            ...
            <div className="relative">
                {/* Center Line */}
                <div className="absolute md:left-1/2 transform md:-translate-x-1/2 h-full border-l-3 border-[var(--color-primary)]"></div>
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="flex items-center w-full relative">
                        ...
                        <div className="block md:hidden md:w-1/2 text-left pl-8">
                            <h2 className="text-[var(--color-primary)] font-bold text-lg">Step 01</h2>
                            <p className="font-semibold">Search for your course</p>
                            <p className="text-sm text-[var(--color-primary)]">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni nesciunt.</p>
                        </div>
                    ...
                    <div className="flex items-center w-full relative">
                        {/* text content */}
                        <div className="block md:invisible md:w-1/2 text-left pl-8">
                        ...
                        <div className="">
                            {/* Step Mark */}
                            <div className="absolute left-0 md:left-1/2 transform -translate-x-1/2 w-8 h-8 bg-[var(--color-primary)] rounded-full flex items-center justify-center text-[var(--color-secondary)]">
                                <FaBook className="z-10"></FaBook>
                            </div>
                        </div>
                        {/* Blank div for right side. there is no content */}
                        <div className="hidden md:block md:w-1/2 text-left pl-8">
                            <h2 className="text-[var(--color-primary)] font-bold text-lg">Step 02</h2>
                            <p className="font-semibold">Take a sample lesson</p>
                            <p className="text-sm text-[var(--color-primary)]">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni nesciunt.</p>
                        </div>
