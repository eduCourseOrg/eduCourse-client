      ...
      <div className="grid mt-2 grid-cols-3 ">
        <div className="  mr-2 grid-col-1">
          ...
          <div className="bg-gray-100 border-2 w-full max-w-xl p-4 border-slate-200 mr-2 mb-2 ">
            ...
            <div className="w-full max-w-xl p-4 flex justify-between flex-col sm:flex-row gap-2">
            ...
            <div className="my-2">
              ...
              <article className="flex bg-white transition hover:shadow-xl dark:bg-gray-900 dark:shadow-gray-800/25">
                ...
                <div className="flex flex-1 flex-col justify-between">
                  ...
                  <dl className="mt-6 flex flex-col m-2 sm:flex-row justify-between items-start sm:items-center gap-4">
                    {/* Published Date on the Left */}
                    <div className="flex items-center gap-2">
                      <dt className="text-gray-700">
                        <span className="sr-only">Published on</span>
