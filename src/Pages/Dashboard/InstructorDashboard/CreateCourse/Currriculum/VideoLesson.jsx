  ...
  return (
    <div className="h-full flex flex-col w-full bg-white">
      ...
      <div className="w-full h-full py-2 px-5 rounded bg-white flex-grow overflow-y-auto">
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 h-10 w-full">
            ...
            <button
              disabled
              className="h-full px-3 rounded bg-primary text-secondary disabled:bg-gray-600/50"
            >
              Save
            </button>
          </div>
          ...
          <div className="bg-secondary h-10 p-1 w-fit rounded flex items-center">
            <button
              ...
              className={`${
                activeButton && "bg-white text-primary"
              } h-full px-18 rounded cursor-pointer`}
            >
              Lesson
            </button>
            <button
            ...
            <div className="w-full flex flex-col gap-4 border-t border-gray-200/90 py-4">
              ...
              <div className="w-full flex flex-col gap-2 pb-3">
                ...
                <textarea
                  ...
                  id=""
                  rows={3}
                  className="border border-secondary focus:outline-none focus:ring-1 focus:ring-[var(--color-primary)] focus:border-transparent transition duration-200 rounded px-3 py-2"
                >
                  Enter Your Question
                </textarea>
                <button
                  type="submit"
                  className="rounded p-2 bg-primary text-secondary w-24 cursor-pointer"
                >
                  Submit
                </button>
              </div>
                ...
                <div className="w-full flex flex-col gap-10">
                  <div className="w-full h-10 flex items-center justify-between ">
                    ...
                    <div className="w-full h-full flex items-center justify-end gap-2">
                      <button className="rounded bg-primary text-secondary w-20 h-full cursor-pointer">
                        Reply
                      </button>
                ...
                <div className="w-full flex flex-col gap-1">
                  ...
                  <div className="bg-secondary w-full p-4 flex flex-col gap-8">
                    ...
                    <p>
                      ...
                      Laudantium temporibus repellat quidem quis quia possimus
                      officiis, accusantium blanditiis minus dolorem quas!
                      Architecto ex molestias neque recusandae reprehenderit,
                      nisi corrupti aliquid laudantium laborum fugit quo
                      quibusdam dolores quam amet error doloribus obcaecati
                      nulla necessitatibus accusantium, exercitationem fuga,
                      perferendis veritatis? Alias cumque minus nemo recusandae
                      similique repellat atque, nulla pariatur tempora. Minus.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="w-full h-15 flex justify-end px-5 py-2 bg-white">
        <button
          disabled
          className="h-full px-5 rounded bg-primary text-secondary disabled:bg-gray-600/50"
        >
          Save
        </button>
      </div>
