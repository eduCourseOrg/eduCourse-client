            ...
            <div className="">
             <label htmlFor="name" className="block text-sm/6 font-medium text-gray-900">
              ...
              <div className="mt-2">
                ...
                />
                {errors.name?.type==='required' && <span className="text-red-700">Name is required</span>}
              ...
              <div className="mt-2">
                ...
                />
                   {errors.password?.type === 'required' && <p className="text-red-600">Password is required</p>}
                                {errors.password?.type === 'minLength' && <p className="text-red-600">Password should 6 characters long</p>}
