...
const SignUpForm = ({setIsLogin}) => {
    const {createAccount,googleLogin} = useContext(EduCourseContexts);
    const {
    register,
    handleSubmit,
    reset ,
    ...
    return (
      <div>
        <form onSubmit={handleSubmit(onSubmit)} className="">
            ...
            <div className="">
              ...
              <div className="mt-2">
                ...
                {errors.name?.type === "minLength" && (
                  <span className="text-red-700">Valid Name is required</span>
                )}
              ...
              <label
                htmlFor="number"
                className="mt-3 block text-sm/6 font-medium text-gray-900"
              >
                Phone number
              </label>
              ...
              <div className="mt-4">
                <input
                  ...
                  className=" w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[var(--color-primary)] sm:text-sm/6"
                  {...register("number", {
                    required: true,
                    minLength: 11,
                  })}
          ...
          <p className="my-6 flex justify-center items-center">
            Already have an account?{" "}
            <Link
              onClick={() => setIsLogin(true)}
              className="text-teal-900 font-bold px-3 text-[18px]"
            >
              Log In
            </Link>
          </p>
        ...
        <div>
          <button
            ...
            className="m-auto w-2/3 flex justify-center items-center bg-white dark:bg-teal-900 border-2 border-teal-700 rounded-lg shadow-lg px-6 py-2 text-[15px] font-medium text-teal-800 dark:text-white hover:text-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200"
          >
            <svg
