...
import { IoIosMail, IoIosPeople } from "react-icons/io";
  ...
  const { data: instructorData = {},isLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `http://localhost:5000/instructors/6815b1173b9f8e0a4a131ed0`
      );
   ...
   const parsed = JSON.parse(instructorData?.image?.image);
   const restoredArray = new Uint8Array(parsed);

   const mimeType = instructorData?.mimeType || "image/png";
  // const imageArray = JSON.parse(instructorData?.image);
  console.log("imageArray restoredArray", restoredArray);

    const imageBlob = new Blob([restoredArray], { type: mimeType });
    const outputImageUrl = URL.createObjectURL(imageBlob);
// console.log("outputImageUrl", outputImageUrl);

  // console.log("instructorData tan", instructorData);
        ...
        <div className="md:w-[30%] flex flex-col gap-8 items-center">
          ...
          <div className="w-full h-auto flex flex-col items-center gap-3 rounded-lg p-2 shadow-lg shadow-gray-400 bg-white">
            ...
            <div className="flex items-center justify-center gap-3 mb-3">
              <span className="p-2 rounded text-xs text-[var(--color-secondary)] bg-[var(--color-primary)]">
          ...
          <div className="w-full h-auto flex flex-col gap-3 rounded-lg p-2 shadow-lg shadow-gray-400 bg-white">
            ...
            <div className="py-5 px-2 flex flex-col gap-5 items-start">
              ...
              <div className="flex items-center gap-3">
                <span className="rounded p-3 bg-[var(--color-primary)] text-[var(--color-secondary)] text-xl">
                  <FaGraduationCap />
                </span>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-5">
              <p>
                ...
                Debitis quos temporibus perferendis, explicabo quia hic. Animi
                ab nostrum ut sed. Lorem ipsum dolor sit amet consectetur
                adipisicing elit. Nisi voluptatem vel, impedit quae, veritatis
                assumenda nostrum non est perspiciatis debitis saepe porro
                facilis natus cupiditate, rem illo sint. Provident ratione quod
                deserunt at voluptatem ea pariatur sunt eligendi earum sapiente!
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Commodi nihil voluptatum nulla eveniet? Aliquam ex ullam harum
                quibusdam odit voluptate vel magnam dolorum. Cumque, laudantium.
                Ea quis voluptas quia sed, qui, sapiente atque culpa dolor
                nesciunt ducimus rerum! Ducimus laboriosam quis iste eos, autem
                animi? Earum autem possimus animi sunt? Lorem ipsum dolor sit
                amet, consectetur adipisicing elit. Aliquam unde natus placeat?
                Architecto, voluptatum soluta nihil veniam ullam neque amet
                alias quasi ex molestiae suscipit ipsa aliquam dicta? Eius
                voluptas, consequatur neque tempora nemo maxime, accusamus alias
                magnam ea magni, unde est. Ipsum amet magnam voluptatem officiis
                quod nisi minus?
              </p>
            </div>
              ...
              <div className="w-full bg-white shadow shadow-gray-400 rounded-lg">
                ...
                <div className="w-full h-[52%] px-3 flex flex-col gap-1">
                  ...
                  <div className="flex items-center justify-between font-semibold grow ">
                    ...
                    <span className="flex items-center gap-1">
                      <FaCalendarAlt></FaCalendarAlt> Beginner
                    </span>
                  </div>
                </div>
              </div>
