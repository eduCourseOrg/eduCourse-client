    ...
    return (
        <div className="w-full h-screen flex border border-red-500">
            <div className="w-[25%] h-full flex flex-col gap-4 bg-[#e0f9f6] p-4 text-primary">
                ...
                <NavLink to="/instructorReg" end className={({isActive}) => `${isActive && 'border border-[var(--color-primary)]'} bg-white px-2 py-1 rounded`}>
                    <div className="flex justify-between items-center">
                        <div>
                            <h3 className="font-bold">Step - 1</h3>
                            <p>Add Your Personnel Info</p>
                        </div>
                        <button className="px-2 rounded-md border border-primary w-fit h-fit">Pending</button>
                    </div>
                </NavLink>
                <NavLink to="step2" className={({isActive}) => `${isActive && 'border border-[var(--color-primary)]'} bg-white px-2 py-1 rounded`}>
                    <div className="flex justify-between items-center">
                        <div>
                ...
                <NavLink to="step3" className={({isActive}) => `${isActive && 'border border-[var(--color-primary)]'} bg-white px-2 py-1 rounded`}>
                    <div className="flex justify-between items-center">
                        <div>
